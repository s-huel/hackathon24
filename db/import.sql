...
CREATE TABLE `Admin` (
    `AdminID` INT UNIQUE NOT NULL PRIMARY KEY,
...
CREATE TABLE `Teacher` (
    `TeacherID` VARCHAR(5) UNIQUE NOT NULL PRIMARY KEY,
    `Email` VARCHAR(255) UNIQUE NOT NULL,
    `Password` VARCHAR(255) NOT NULL,
    `FirstName` VARCHAR(255) NOT NULL,
    `LastName` VARCHAR(255) NULL,
...
CREATE TABLE `Class` (
    `Classnumber` INT UNIQUE NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `Student` (
    `Studentnumber` INT UNIQUE NOT NULL AUTO_INCREMENT,
    `Email` VARCHAR(255) UNIQUE NOT NULL,
    `Password` VARCHAR(255) NOT NULL,
    `FirstName` VARCHAR(255) NOT NULL,
    `LastName` VARCHAR(255) NULL,
